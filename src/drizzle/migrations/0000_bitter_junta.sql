...
CREATE TYPE "public"."job_listing_status" AS ENUM('draft', 'public', 'delisted');--> statement-breakpoint
...
CREATE INDEX "job_listings_stateAbbrevation_index" ON "job_listings" USING btree ("stateAbbrevation");